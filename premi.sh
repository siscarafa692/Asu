...
data_ip="https://raw.githubusercontent.com/siscarafa692/Asu/main/izin"
checking_sc() {
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/siscarafa692/Asu/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/siscarafa692/Asu/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/siscarafa692/Asu/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/siscarafa692/Asu/main/"
...
echo -e "     \e[1;32m2)\e[0m Use a Random jangan"
echo -e "   ------------------------------------"
